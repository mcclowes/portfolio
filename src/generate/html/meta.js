const meta = (config) => {
  if(!config || !config.name) {
    ...
    <meta name="description" content="Portfolio made with cv-maker">
  ...
  return `
    ...
    <!--  Social tags -->
    <!--  Essential META Tags -->
    <meta property="og:title" content="The Portfolio of ${config.name}">
    ...
    <meta property="og:site_name" content="The Portfolio of ${config.name}">
